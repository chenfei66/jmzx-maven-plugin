...
import com.jmzx.maven.plugin.utils.HtmlCompressor;
    ...
    public void doProcessPageFile() {
        ...
        for (PageInfo pageInfo : pages) {
            ...
            try {
                ...
                if(pageInfo.getFile().getName().toLowerCase().endsWith("html") ) {
                    sb = new StringBuffer(HtmlCompressor.compress(sb.toString()));
                }
