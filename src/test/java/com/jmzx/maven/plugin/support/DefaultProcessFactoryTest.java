...
import com.jmzx.maven.plugin.support.logger.SystemLogger;

/**  
* @Package 
*	 com.iqarr.maven.plugin.support
* @ClassName: 
*	 DefaultProcessFactoryTest  
* @since 
*	  V1.0
* @author 
*		zhangyong   
...
public class DefaultProcessFactoryTest {
	...
	/**
	 * Test method for {@link DefaultProcessFactory#processCompressionJsCss(java.util.List, java.lang.String, JCVConfig)}.
	 */
	@Test
