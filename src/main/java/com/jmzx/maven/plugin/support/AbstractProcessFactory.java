package com.jmzx.maven.plugin.support;

import static com.jmzx.maven.plugin.utils.BaseUtils.checkStrIsInList;
import static com.jmzx.maven.plugin.utils.HtmlUtils.getHtmllabDocposition;
...
import com.jmzx.maven.plugin.domain.JCVFileInfo;
import com.jmzx.maven.plugin.domain.JCVMethodEnum;
import com.jmzx.maven.plugin.utils.Md5Utils;
import org.mozilla.javascript.EvaluatorException;

import com.jmzx.maven.plugin.constant.JCVConstant;
import com.jmzx.maven.plugin.domain.DocPosition;
import com.jmzx.maven.plugin.domain.PageInfo;
import com.jmzx.maven.plugin.exception.YUIException;
import com.jmzx.maven.plugin.support.logger.LoggerFactory;
import com.jmzx.maven.plugin.utils.BaseUtils;
...
public abstract class AbstractProcessFactory implements ProcessFactory {
	...
	* Description:     
	* @see ProcessFactory#initDisplayInfo()
	*/
	@Override
    ...
    */
     ...
     * <p>Description: 初始化</p>  
     * @param webAppRoot  
     * @see ProcessFactory#initJcv(java.lang.String)
     */
      ...
      * @param pages
      * 
      * @see ProcessFactory#doProcessPageFile(java.util.List)
      */
